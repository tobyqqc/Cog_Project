...
public class DateTimeKit {
	...
	public static String getPlayDate2() {
	...
	public static String transferLongToDate(String format, long time) {
	...
	public static void main(String[] args) {
		...
		// List<String> weeks = getDaysBetweenTwoDates(parse("2017-2-2"),
		// parse("2017-3-14"));
		//
