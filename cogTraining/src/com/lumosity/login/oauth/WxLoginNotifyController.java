...
public class WxLoginNotifyController extends Controller{
	...
	public void index() {
		...
		try {
             ...
             if (requestType != null && requestType.equalsIgnoreCase("XMLHttpRequest")&&false) {
                 response.addHeader("loginStatus", "accessDenied");
                 response.sendError(HttpServletResponse.SC_FORBIDDEN);
                 renderJson("error");
             } else {
     			WxMpOAuth2AccessToken wxMpOAuth2AccessToken = WxService.oauth2getAccessToken(code);
    			System.out.println("=wxMpOAuth2AccessToken=" + wxMpOAuth2AccessToken.getOpenId());
